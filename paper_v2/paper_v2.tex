...
Proofs are given in Appendix~\ref{app:tweedie-proofs}. We now apply these estimators: Section~\ref{sec:brownian} identifies the Brownian bridge drift through the Gaussian form of Tweedie's formula, and Section~\ref{sec:poisson} its Poisson counterpart.
